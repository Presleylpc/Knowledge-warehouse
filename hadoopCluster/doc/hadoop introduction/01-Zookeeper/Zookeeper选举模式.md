...
![Zookeeper Architecture](./pic/role.png)
...
![Zookeeper Leader Write](./pic/writeleader.png)
...
![Zookeeper Follower/Observer Write](./pic/writefollower.png)
...
- **FOLLOWING** 
  ...
  跟随者状态。表明当前服务器角色是Follower，并且它知道Leader是谁
...
- **OBSERVING**
   ...
   观察者状态。表明当前服务器角色是Observer，与Folower唯一的不同在于不参与选举，也不参与集群写操作时的投票
...
![Cluster start election step 1](./pic/start_election_1.png)
...
> 服务框中的元组含义为 (ServerID，推荐的ServerID)
...
![Cluster start election step 2](./pic/start_election_2.png)
...
![Cluster start election step 3](./pic/start_election_3.png)
...
![Follower restart election step 1](./pic/follower_restart_election_1.png)
...
![Follower restart election step 2](./pic/follower_restart_election_2.png)
...
![Leader restart election step 1](./pic/leader_restart_election_1.png)
...
![Leader restart election step 2](./pic/leader_restart_election_2.png)

**选出新Leader**
经过上一步选票更新后，服务器1与服务器2均将选票投给服务器1，因此服务器2成为Follower，而服务器1成为新的Leader并维护与服务器2的心跳。


![Leader restart election step 3](./pic/leader_restart_election_3.png)
...
![Leader restart election step 4](./pic/leader_restart_election_4.png)
...
![Leader restart election step 5](./pic/leader_restart_election_5.png)
...
![Leader Failover step 1](./pic/recovery_1.png)
...
![Leader Failover step 2](./pic/recovery_2.png)
...
![Leader Failover step 3](./pic/recovery_3.png)
...
![Leader Failover step 4](./pic/recovery_4.png)
