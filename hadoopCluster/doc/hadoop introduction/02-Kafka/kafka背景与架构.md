...
partition 是物理上的概念，每个 topic 包含一个或多个 partition。kafka 分配的单位partition。
**5. consumer：**
...
![kafka architecture 架构](./pic/KafkaArchitecture.png)
...
　　![kafka topic partition](./pic/topic-partition.png)
　　
...
　　![kafka partition event index](./pic/partition_segment.png)
　　
　　因为每条消息都被append到该Partition中，属于顺序写磁盘，因此效率非常高（经验证，顺序写磁盘效率比随机写内存还要高，这是Kafka高吞吐率的一个很重要的保证）。
　　![kafka 顺序写磁盘](./pic/partition.png)
　　
...
　　![kafka consumer group](./pic/consumer_group.png)
...
　　![kafka sample deployment in linkedin](./pic/kafka_in_linkedin.png)
　　
...
　　![kafka consumer group](./pic/consumer_group_test.png)　　
